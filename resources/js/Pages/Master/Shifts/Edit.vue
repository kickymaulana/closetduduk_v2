    ...
    <div class="flex flex-col gap-6 p-4 md:p-8 pt-1">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-4">
                ...
                <h2 class="text-3xl font-bold tracking-tight">Edit Shift</h2>
            </div>
        </div>
                ...
                >
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle
                                    >Hapus Data Shift?</AlertDialogTitle
                                >
                                <AlertDialogDescription>
                                    Tindakan ini tidak dapat dibatalkan. Ini
                                    akan menghapus data shift
                                    <strong>{{ props.shift.shift }}</strong>
                                    secara permanen.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
