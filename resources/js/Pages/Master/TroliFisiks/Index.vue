...
import {
    ...
    IconSearch,
    IconX,
    IconTruck, // Icon yang lebih cocok untuk Troli
...
const props = defineProps<{
    troliFisiks: {
        data: Array<{ id: number; nomor: string; created_at: string }>;
        links: any[];
        from: number;
        to: number;
        total: number;
        ...
        <Card class="border-none shadow-sm">
            ...
            >
                <CardTitle class="text-xl font-bold flex items-center gap-2">
                    <IconTruck class="size-6 text-primary" />
                    Master Troli Fisik
                </CardTitle>
