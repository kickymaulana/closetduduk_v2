...
const confirmSelesai = () => {
    router.post(
        route("trolis.selesaikan", props.troli.id),
        {},
        {
            onSuccess: () => {
                toast.success("Berhasil!", {
                    description:
                        "Troli berhasil pindahkan ke proses selanjutnya.",
                });
            },

            onError: (errors) => {
                const message =
                    errors.qr || errors.error || "Terjadi kesalahan sistem.";
                // Sonner Error
...
const confirmHapus = () => {
    router.post(
        route("trolis.hapus_store", props.troli.id),
        {},
        {
            onSuccess: () => {
                toast.success("Berhasil!", {
            ...
            <DropdownMenu>
                ...
                <DropdownMenuContent align="end" class="w-48">
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle
                                    >Selesaikan Proses
                                    Sekarang?</AlertDialogTitle
                                >
                                <AlertDialogDescription>
                                    Troli ini akan dipindahkan ke tahap
                                    berikutnya. Semua status produk di dalamnya
                                    akan direset menjadi <b>Belum Scan</b> untuk
                                    tahap baru.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
                    ...
                    <DropdownMenuItem as-child>
                        <Link
                            :href="route('trolis.kembalikan', props.troli.id)"
                        >
                            <IconArrowBackUp
                                class="mr-2 size-4 text-green-500"
                            />
                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent>
                            <AlertDialogHeader>
                                <AlertDialogTitle
                                    >Hapus Troli
                                    {{ troli.nomor }}?</AlertDialogTitle
                                >
                                <AlertDialogDescription>
                                    Tindakan ini tidak dapat dibatalkan. Troli
                                    hanya bisa dihapus jika
                                    <b>tidak ada produk</b> di dalamnya. Status
                                    fisik troli di sistem akan diubah menjadi
                                    <b>"Tidak"</b> (Tersedia).
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                            <AlertDialogFooter>
            ...
            >
                <CardTitle class="text-xl font-bold flex flex-col gap-1">
                    ...
                    <span class="text-sm font-normal text-muted-foreground"
                        >Total Produk: {{ produks.total }} |
                        <Badge> Proses: {{ troli.proses?.proses }} </Badge>
                    </span>
                </CardTitle>
                ...
                <div class="flex flex-wrap items-center gap-2 w-full md:w-auto">
                    ...
                    >
                        <Link
                            :href="
                                route('trolis.produk.scan_awal', props.troli.id)
                            "
                        >
